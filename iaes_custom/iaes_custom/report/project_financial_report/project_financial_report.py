...
def get_columns():
    return [
        ...
        {"label": _("SINV Billed Net (Excl. VAT)"),       "fieldname": "sinv_value",          "fieldtype": "Currency", "options": "currency", "width": 170},
        {"label": _("SINV Collected (Incl. VAT)"),    "fieldname": "sinv_paid",           "fieldtype": "Currency", "options": "currency", "width": 175},
        {"label": _("SINV Outstanding (Incl. VAT)"),  "fieldname": "sinv_outstanding",    "fieldtype": "Currency", "options": "currency", "width": 185},
        {"label": _("SINV Count"),                   "fieldname": "sinv_count",          "fieldtype": "Int",                             "width": 90},
        {"label": _("PINV Net Cost (Excl. VAT)"),    "fieldname": "pinv_value",          "fieldtype": "Currency", "options": "currency", "width": 175},
        {"label": _("PINV Paid (Incl. VAT)"),         "fieldname": "pinv_paid",           "fieldtype": "Currency", "options": "currency", "width": 160},
        {"label": _("PINV Outstanding (Incl. VAT)"),  "fieldname": "pinv_outstanding",    "fieldtype": "Currency", "options": "currency", "width": 185},
